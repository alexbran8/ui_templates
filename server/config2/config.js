...
const hostUrl = process.env.NODE_ENV === `development` ? "http://localhost:4000/auth/twitter/redirect" :  'https://ecosystem.eecloud.dynamic.nsn-net.net/auth/twitter/redirect';
