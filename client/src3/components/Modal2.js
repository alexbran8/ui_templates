...
export default class PromiseModal extends React.Component {
  ...
  render() {
    ...
    //   class = "modal23e54"
        ...
        onHide={
          this.props.event
            ? () => {this.props.reset();resolve()}
            : () => {this.props.resetEdit();resolve()}
        }
        onOk={() => {
          this.hide();
          resolve();
        ...
        <Modal.Header closeButton>
          ...
          <Modal.Footer>
            ...
            <button
              ...
              onClick={
                this.props.event
                  ? () => {this.props.sendData(this.props.event);this.props.reset();resolve()}
                  : () => {this.props.updateData(this.props.editEvent);this.props.resetEdit();resolve()}
              }
            >
